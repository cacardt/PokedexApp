...
fun PokedexPhotoApp() {
    ...
    val pokeViewModel: PokedexViewModel = viewModel(factory = PokedexViewModel.Factory)
    Surface(
        modifier = Modifier
            .fillMaxSize(),
        color = Color.White
        ...
        NavHost(navController = navController, startDestination = Screen.PokemonListScreen.route) {
            composable(Screen.PokemonListScreen.route) {
                HomeScreen(
                    ...
                    onPokemonClick = { pokemonId ->
                        navController.navigate(Screen.PokemonDetailScreen.createRoute(pokemonId))
                    },
            ...
            composable(
                ...
                PokemonDetailScreen(pokemonId = pokemonId, viewModel = pokeViewModel, navController)
            }
        }
    }
}
